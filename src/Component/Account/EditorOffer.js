...
const EditorOffer = (props) => {
        ...
        await fetch(config.apiRoot + "/api/CarOfferEditor/" + props.match.params.id, {
            ...
            .then(res => {
                ...
                if (res.succeeded == true) {
                    ...
                    getModelList(res.carOffer.carProducent)
    ...
    const removeImage = (index) => {
        setImagesGallery((imagesGallery).splice(index-1, 1))
    }

    useEffect(() => {
      
    }, [imagesGallery, yearList, modelList, advertDataValue.equipment]);
    ...
    return (
        <div className="advert-editor">
                ...
                <div className="advert-editor__row">
                    ...
                    <div className="advert-editor__content">
                        ...
                        <Select
                            ...
                            value={advertDataValue.carModel == null ? "" : { value: advertDataValue.carModel, label: modelList.length > 0 ? modelList.find((x) => { return x.value == advertDataValue.carModel }).label : "" }}
            ...
            <div className="advert-editor__row">
                <div className="advert-editor__button  advert-editor__button--submit" onClick={x => submit()} >Zapisz zmiany</div>
            </div>
        </div>
    )
}
